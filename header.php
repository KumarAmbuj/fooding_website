...
$sql11="select * from usersignup where setmobilenumber='$getname11'";
...
<div class="header">
		...
		<div style="display:none;"
			...
			<a href="login.php" style="color:white; padding:10px;">Login </a>
				...
				<a href="logout.php" style="color:white; padding:10px;">Logout</a>
				...
				<ul>
					<li class="dropdown head-dpdn">
						...
						<div style="dispaly:none;">	<li><a href="login.php"></a></li></div> 
						</ul> 
					</li> 
					<li class="dropdown head-dpdn">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-percent" aria-hidden="true"></i> Today's Deals<span class="caret"></span></a>
						<ul class="dropdown-menu">
						<div style="dispaly:none;">	<li><a href="offers.php"></a></li></div> 
							<li><a href="#"></a></li>
							<li><a href="#"></a></li> 
						</ul> 
					</li> 
		...
		<div class="header-two"><!-- header-two -->
			<div class="container">
				<div class="header-logo">
					<h1><a href="index.php"><span>M</span>agicpace </a></h1>
  ...
  location.replace("cart.php")
		...
		<div class="header-three"><!-- header-three -->
			<div class="container">
				...
				<div class="move-text">
					<div class="marquee" style="color:white; font-size:16px;"> best fooding site for college students </div>
