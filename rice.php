				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="#"><img src="images/vegrice.jpg" class="img-responsive" style="height:100px;" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="#">Veg rice</a></h5> 
								<h6><del>Rs.70</del> Rs.50</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="Veg rice" /> 
									<input type="hidden" name="amount" value="50.00" /> 
									<input type="submit" name="veg_rice" value="Add to cart">
								</form> 
							</div>
						</div> 
					</div>
...
<?php
if(isset($_POST["veg_rice"]))
{

$insert="insert into cart(id,setmobilenumber,setitem,setcontent,setprice,setdate,settime)values(NULL,'$getmobilenumber','veg rice','1','50','$getdate','$gettime')";
...
?>
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="#"><img src="images/eggrice.jpg" class="img-responsive" style="height:100px;" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="#">Egg rice</a></h5> 
								<h6><del>Rs.80</del> Rs.60</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="egg rice" /> 
									<input type="hidden" name="amount" value="60.00" /> 
									<input type="submit" name="egg_rice" value="Add to cart">
								</form> 
							</div>
						</div> 
					</div>
...
<?php
if(isset($_POST["egg_rice"]))
{

$insert="insert into cart(id,setmobilenumber,setitem,setcontent,setprice,setdate,settime)values(NULL,'$getmobilenumber','egg_rice','1','60','$getdate','$gettime')";
$result=mysqli_query($con,$insert);
if($insert==true)
{
...
?>
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="#"><img src="images/chickenrice.jpg" class="img-responsive" style="height:100px;" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="#">Chicken Rice</a></h5> 
								<h6><del>Rs.85</del> Rs.70</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="Chicken rice"/> 
									<input type="hidden" name="amount" value="70.00"/> 
									<input type="submit" name="chicken_rice" value="Add to cart">
								</form> 
							</div>
						</div> 
					</div>
...
<?php
if(isset($_POST["chicken_rice"]))
{

$insert="insert into cart(id,setmobilenumber,setitem,setcontent,setprice,setdate,settime)values(NULL,'$getmobilenumber','chicken rice','1','70','$getdate','$gettime')";
$result=mysqli_query($con,$insert);
if($insert==true)
{
...
?>
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href="#"><img src="images/mixrice.jpg" class="img-responsive" style="height:100px;" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="#">Mix Rice</a></h5> 
								<h6><del>Rs.100</del> Rs.80</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="Mix Rice"/> 
									<input type="hidden" name="amount" value="80.00"/> 
									<input type="submit" name="mix_rice" value="Add to cart">
								</form> 
							</div>
						</div> 
					</div>
...
<?php
if(isset($_POST["mix_rice"]))
{

$insert="insert into cart(id,setmobilenumber,setitem,setcontent,setprice,setdate,settime)values(NULL,'$getmobilenumber','mix rice','1','80','$getdate','$gettime')";
$result=mysqli_query($con,$insert);
if($insert==true)
{
...
?>
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href="#"><img src="images/chillichickenrice.jpg" class="img-responsive" style="height:100px;" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="#">Chilli Chicken Rice</a></h5> 
								<h6><del>Rs.120</del>Rs.100</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="Chilli Chicken Rice"/> 
									<input type="hidden" name="amount" value="100.00"/> 
									<input type="submit" name="chilli_chicken_rice" value="Add to cart">
								</form> 
							</div>
						</div> 
					</div>
...
<?php
if(isset($_POST["chilli_chicken_rice"]))
{

$insert="insert into cart(id,setmobilenumber,setitem,setcontent,setprice,setdate,settime)values(NULL,'$getmobilenumber','chilli chicken rice','1','100','$getdate','$gettime')";
$result=mysqli_query($con,$insert);
if($insert==true)
{
